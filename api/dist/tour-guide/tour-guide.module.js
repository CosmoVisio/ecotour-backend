...
const tour_guide_controller_1 = require("./tour-guide.controller");
...
exports.TourGuideModule = TourGuideModule = __decorate([
    (0, common_1.Module)({
        controllers: [tour_guide_controller_1.TourGuideController],
        providers: [tour_guide_service_1.TourGuideService],
    })
], TourGuideModule);
